            ...
            return (
                <div className="w-full max-w-md mx-auto p-6 glass-card rounded-2xl text-center animate-fade-in">
                    ...
                    <button
                        ...
                        className="px-6 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium hover:shadow-lg hover:shadow-purple-500/30 transition-all"
                    >
                        Try Again
                    </button>
                </div>
